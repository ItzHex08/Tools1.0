...
def main_log():
        ...
        code_log_1 = (datetime.now() + timedelta(hours=9)).strftime('[%H:%M:%S]')+" Installing Packages ...\n"
        time.sleep(1)
        file_log.write(code_log_1)
        code_log_2 = (datetime.now() + timedelta(hours=9)).strftime('[%H:%M:%S]')+" Installing File requirements.txt ...\n"
        time.sleep(1)
        file_log.write(code_log_2)
        code_log_3 = (datetime.now() + timedelta(hours=9)).strftime('[%H:%M:%S]')+" Installing Folder data ...\n"
        time.sleep(1)
        file_log.write(code_log_3)
        code_log_4 = (datetime.now() + timedelta(hours=9)).strftime('[%H:%M:%S]')+" Installing Folder log ...\n"
        time.sleep(1)
